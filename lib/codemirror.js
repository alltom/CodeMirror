  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateSelection() {
      ...
      if (collapsed) {
        ...
        var middleStart = Math.max(0, sel.from.ch ? fromPos.bottom - .5 : fromPos.top);
        var middleHeight = toPos.top + (sel.from.ch ? 1 : 0) - middleStart;
        if (middleHeight > 2)
    ...
    function localCoords(pos, inLineWrap) {
      ...
      return {left: sp.left, top: y + sp.top, bottom: y + sp.bottom};
    }
    ...
    function pageCoords(pos) {
      ...
      return {left: off.left + local.left, top: off.top + local.top, bottom: off.top + local.bottom};
    }
